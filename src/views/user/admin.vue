<template>
    ...
    <el-form :inline="true" :model="fuquery" class="demo-form-inline">
        <el-form-item label="学号">
            <el-input v-model="fuquery.aid" placeholder="请输入学号" @keyup.enter="searchSubmit"></el-input>
        </el-form-item>
        ...
        <el-form-item>
            ...
            <el-button type="primary" @click="fuquery.aid = '', fuquery.name = ''">清空</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="新增学生">
        ...
        <el-form ref="ruleFormRef" :model="UserLogin" status-icon label-width="120px" class="demo-ruleForm">
            <el-form-item label="学号" prop="aid">
                <el-input v-model="UserLogin.aid" />
            </el-form-item>
    ...
    <el-table :data="UsertableData.dataList" style="width: 100%" @selection-change="handleSelectionChange"
        ...
        <el-table-column prop="aid" label="管理员ID" />
    ...
    <el-dialog v-model="edit_stulVisible" title="修改用户">
        <el-form ref="ruleFormRef" :model="UserLogin.dataLst" status-icon label-width="120px" class="demo-ruleForm">
            <el-form-item label="学号" prop="aid">
                <el-input v-model="UserLogin.dataLst.aid" />
            </el-form-item>
            <el-form-item label="姓名" prop="name">
...
import {
    ...
    updateadminByIdinfo,
    deleteadminByIdinfo,
    deleteadminsByIdsinfo
} from "@/request/AdminLogin.js";
import {
    getzwid
} from "@/request/mang.js";
...
const deleteByIds = () => {
    for (let i = 0; i < multipleSelection.value.length; i++) {
        ...
        selectIds[i] = selectionElement.aid;
    }
    deleteadminsByIdsinfo({
        aid: selectIds
    }).then(res => {
